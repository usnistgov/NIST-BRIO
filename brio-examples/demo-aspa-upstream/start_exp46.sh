...
EXPERIMENT_NAME="demo-aspa-upstream:exp46"

ENABLE_ROUTER=1
ENABLE_BRIO2=1

CFG_CACHE_NAME="exp46.brio_rc.script"
CFG_BRIO1_NAME="exp46.brio_tg.as65030.conf"
CFG_BRIO2_NAME="exp46.brio_tg.as65000.conf"
