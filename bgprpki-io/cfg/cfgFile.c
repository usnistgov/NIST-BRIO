 ...
 * ChangeLog:
 * -----------------------------------------------------------------------------
 *  0.7.0.1 - 2025/02/10 - oborchert
 *            * Renamed cfg file header entry from BGPSec-IO to BGPRPKI-IO
 *  0.2.3.0 - 2021/09/29 - oborchert
 *            * Fixed bug in retrieveIPAddr
 *          - 2021/08/21 - oborchert
 *            * Moved code into initial BRIO base
...
{  
  ...
  if (file)
  {
    fprintf (file, "#BGPRPKI-IO Configuration file. Auto generated by %s %s\n\n", 
