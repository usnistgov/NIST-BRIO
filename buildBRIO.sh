#!/bin/bash
# This script is auto-generated by BGP-SRx Software Suite Bundler V9.4.2

# Date: Sun Jul 20 23:07:41 EDT 2025

SCRIPTNAME='BRIO Software Suite Vb7.1.2 Build script V9.4.2!'
...
case "$OS_NAME" in 
  ...
  *)
    ...
    echo
    echo "The build script will be generated for the following list of"
